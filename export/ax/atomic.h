...
typedef ax_i32 ax_atomic_i32;
typedef void*  ax_atomic_void_ptr;

#if !AX_MSVC && (AX_GCC || AX_CLANG)

inline static
ax_i32 ax_atomic_i32_load(ax_atomic_i32* p)
{
...
inline static
void ax_atomic_i32_store(ax_atomic_i32* p, ax_i32 desired)
{
#if defined(__i386__) || defined(__x86_64__)
    __sync_synchronize();
...
inline static
ax_i32 ax_atomic_i32_inc(ax_atomic_i32* p)
{
    return (ax_i32)__sync_add_and_fetch(p, 1);
}

inline static
ax_i32 ax_atomic_i32_dec(ax_atomic_i32* p)
{
    return (ax_i32)__sync_sub_and_fetch(p, 1);
}

inline static
ax_i32 ax_atomic_i32_add(ax_atomic_i32* p, ax_i32 value)
{
    return (ax_i32)__sync_add_and_fetch(p, value);
}

inline static
ax_i32 ax_atomic_i32_sub(ax_atomic_i32* p, ax_i32 value)
{
    return (ax_i32)__sync_sub_and_fetch(p, value);
}

inline static
ax_i32 ax_atomic_i32_xchg(ax_atomic_i32* p, int desired)
{
    return (ax_i32)__sync_lock_test_and_set(p, desired);
}

inline static
void* ax_atomic_ptr_load(ax_atomic_void_ptr* p)
{
#if defined(__i386__) || defined(__x86_64__)
...
inline static
void ax_atomic_ptr_store(ax_atomic_void_ptr* p, void* desired)
{
#if defined(__i386__) || defined(__x86_64__)
    __sync_synchronize();
...
inline static
void* ax_atomic_ptr_xchg(ax_atomic_void_ptr* p, void* desired)
{
...
inline static
ax_i32 ax_atomic_i32_xchg(ax_atomic_i32* p, ax_i32 desired)
{
